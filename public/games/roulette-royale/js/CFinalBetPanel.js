function CFinalBetPanel(iX, iY) {
  ...
  this._init = function (iX, iY) {
    _aNumberFinals = [];
    _aNumberFinals[0] = [0, 10, 20, 30];
    _aNumberFinals[1] = [1, 11, 21, 31];
    _aNumberFinals[2] = [2, 12, 22, 32];
    _aNumberFinals[3] = [3, 13, 23, 33];
    _aNumberFinals[4] = [4, 14, 24, 34];
    _aNumberFinals[5] = [5, 15, 25, 35];
    _aNumberFinals[6] = [6, 16, 26, 36];
    _aNumberFinals[7] = [7, 17, 27];
    _aNumberFinals[8] = [8, 18, 28];
    _aNumberFinals[9] = [9, 19, 29];
    ...
    s_oGame._onShowBetOnTable(
      {
        ...
        numbers: _aNumberFinals[iIndex],
        bet_mult: iBetMultiplier,
        bet_win: iBetWin,
        num_fiches: _aNumberFinals[iIndex].length,
      },
      false,
    );
