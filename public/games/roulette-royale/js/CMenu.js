function CMenu() {
  ...
  this._init = function () {
    ...
    if (SHOW_CREDITS) {
      ...
      _pStartPosFullscreen = {
        x: _pStartPosInfo.x + oSpriteFullscreen.width / 2 + 10,
        y: oSpriteFullscreen.height / 2 + 10,
      };
    } else {
      _pStartPosFullscreen = {
  ...
  this._onButPlayRelease = async function () {
    ...
    await functions.startGame(ids.roulette_royale.id);
    this.unload();
    s_oMain.gotoGame();
