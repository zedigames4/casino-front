function CNeighborsPanel() {
  ...
  this._init = function () {
    ...
    oBut.addEventListenerWithParams(ON_MOUSE_OVER, this._onNeighborOver, this, {
      index: 0,
    });
    oBut.addEventListenerWithParams(ON_MOUSE_OUT, this._onNeighborOut, this, {
      index: 0,
    });
  ...
  this._initNeighbors = function () {
    _aNeighborsNumbers = [];
    _aNeighborsNumbers[0] = [3, 26, 0, 32, 15];
    _aNeighborsNumbers[1] = [16, 33, 1, 20, 14];
    _aNeighborsNumbers[2] = [4, 21, 2, 25, 17];
    _aNeighborsNumbers[3] = [12, 35, 3, 26, 0];
    _aNeighborsNumbers[4] = [15, 19, 4, 21, 2];
    _aNeighborsNumbers[5] = [23, 10, 5, 24, 16];
    _aNeighborsNumbers[6] = [17, 34, 6, 27, 13];
    _aNeighborsNumbers[7] = [18, 29, 7, 28, 12];
    _aNeighborsNumbers[8] = [11, 30, 8, 23, 10];
    _aNeighborsNumbers[9] = [14, 31, 9, 22, 18];
    _aNeighborsNumbers[10] = [8, 23, 10, 5, 24];
    _aNeighborsNumbers[11] = [13, 36, 11, 30, 8];
    _aNeighborsNumbers[12] = [7, 28, 12, 35, 3];
    _aNeighborsNumbers[13] = [6, 27, 13, 36, 11];
    _aNeighborsNumbers[14] = [1, 20, 14, 31, 9];
    _aNeighborsNumbers[15] = [0, 32, 15, 19, 4];
    _aNeighborsNumbers[16] = [5, 24, 16, 33, 1];
    _aNeighborsNumbers[17] = [2, 25, 17, 34, 6];
    _aNeighborsNumbers[18] = [9, 22, 18, 29, 7];
    _aNeighborsNumbers[19] = [32, 15, 19, 4, 21];
    _aNeighborsNumbers[20] = [33, 1, 20, 14, 31];
    _aNeighborsNumbers[21] = [19, 4, 21, 2, 25];
    _aNeighborsNumbers[22] = [31, 9, 22, 18, 29];
    _aNeighborsNumbers[23] = [30, 8, 23, 10, 5];
    _aNeighborsNumbers[24] = [10, 5, 24, 16, 33];
    _aNeighborsNumbers[25] = [21, 2, 25, 17, 34];
    _aNeighborsNumbers[26] = [35, 3, 26, 0, 32];
    _aNeighborsNumbers[27] = [34, 6, 27, 13, 36];
    _aNeighborsNumbers[28] = [29, 7, 28, 12, 35];
    _aNeighborsNumbers[29] = [22, 18, 29, 7, 28];
    _aNeighborsNumbers[30] = [36, 11, 30, 8, 23];
    _aNeighborsNumbers[31] = [20, 14, 31, 9, 22];
    _aNeighborsNumbers[32] = [26, 0, 32, 15, 19];
    _aNeighborsNumbers[33] = [24, 16, 33, 1, 20];
    _aNeighborsNumbers[34] = [25, 17, 34, 6, 27];
    _aNeighborsNumbers[35] = [28, 12, 35, 3, 26];
    _aNeighborsNumbers[36] = [27, 13, 36, 11, 30];
  ...
  this.clearLastBet = function () {
    ...
    _aValueFichesInPos[iNumberSelected] = roundDecimal(
      _aValueFichesInPos[iNumberSelected],
      1,
    );
  ...
  this.addFicheOnNeighborTable = function () {
    ...
    _aValueFichesInPos[_iNumberClicked] = roundDecimal(
      _aValueFichesInPos[_iNumberClicked],
      1,
    );
    ...
    _aMcFichesAttached[_iNumberClicked] = [];
