function CSeat() {
  ...
  this.setFicheBetted = function (
    ...
    for (var i = 0; i < aNumbers.length; i++) {
      var iWin = (
        parseFloat(_aNumberBetted[aNumbers[i]].win) +
        iWinForBet * (iFicheValue * iNumFiches)
      ).toFixed(1);
  ...
  this.createPileForVoisinZero = function (
    iFicheValue,
    iIndexFicheSelected,
    aNumbers,
    iBetMult,
  ...
  this.createPileForTier = function (
    iFicheValue,
    iIndexFicheSelected,
    aNumbers,
    iBetMult,
  ...
  this.createPileForOrphelins = function (
    iFicheValue,
    iIndexFicheSelected,
    aNumbers,
    iBetMult,
    ...
    var iWin = (
      parseFloat(_aNumberBetted[aNumbers[0]].win) +
      36 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[1]].win) +
      18 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[2]].win) +
      18 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[3]].win) +
      18 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[4]].win) +
      36 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[5]].win) +
      18 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[6]].win) +
      18 * iFicheValue
    ).toFixed(1);
    ...
    iWin = (
      parseFloat(_aNumberBetted[aNumbers[7]].win) +
      18 * iFicheValue
    ).toFixed(1);
  ...
  this.createPileForMultipleNumbers = function (
    ...
    var aFichesMc = [];
    _oFicheController.createPileForMultipleNumbers(
      iIndexFicheSelected,
      aNumbers,
      aFichesMc,
    );
  ...
  this.addFicheOnTable = function (
    ...
    var aFichesMc = [];
    _oFicheController.setFicheOnTable(
      iIndexFicheSelected,
      szNameAttach,
      aFichesMc,
    );
  ...
  this.clearLastBet = function () {
    ...
    for (var i = 0; i < aLastNums.length; i++) {
      if (_aLastBetWinHistory.length > 0) {
        ...
        _aNumberBetted[aLastNums[i]] = {
          win: _aNumberBetted[aLastNums[i]].win - aLastWin[i],
          mc: oTmp.mc,
        };
      } else {
        _aNumberBetted[aLastNums[i]] = {
