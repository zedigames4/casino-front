function CTableController() {
  ...
  this._init = function () {
    ...
    for (var j = 1; j < 13; j++) {
      oBut = new CBetTableButton(
        ...
        iCurY,
        oSprite,
        'bet_' + iCont + '_' + (iCont + 1) + '_' + (iCont + 2),
        _oContainer,
        false,
      );
      oBut.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
  ...
  this._initEnlights = function () {
    ...
    oBmp = new CEnlight(
      11,
      10,
      s_oSpriteLibrary.getSprite('enlight_0'),
      _oContainer,
    );
    ...
    oBmp = new CEnlight(
      347,
      348,
      s_oSpriteLibrary.getSprite('enlight_color'),
      _oContainer,
    );
  ...
  this._onBetPress = function (oParams) {
    ...
    if (aBets !== null) {
      if (_aCbCompleted[ON_SHOW_BET_ON_TABLE]) {
        _aCbCompleted[ON_SHOW_BET_ON_TABLE].call(
          _aCbOwner[ON_SHOW_BET_ON_TABLE],
          oParams,
          false,
        );
      }
  ...
  this._onBetNumberOver = function (oParams) {
    ...
    if (aBets !== null) {
      if (_aCbCompleted[ON_SHOW_ENLIGHT]) {
        _aCbCompleted[ON_SHOW_ENLIGHT].call(
          _aCbOwner[ON_SHOW_ENLIGHT],
          oParams,
        );
      }
    }
  ...
  this._onBetNumberOut = function (oParams) {
    ...
    if (aBets !== null) {
      if (_aCbCompleted[ON_HIDE_ENLIGHT]) {
        _aCbCompleted[ON_HIDE_ENLIGHT].call(
          _aCbOwner[ON_HIDE_ENLIGHT],
          oParams,
        );
      }
    }
