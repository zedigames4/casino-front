...
function CMain(oData) {
  ...
  this.preloaderReady = function () {
    ...
    s_oGameSettingsGlobal = s_oGameSettings;
  ...
  this._loadImages = function () {
    ...
    s_oSpriteLibrary.addSprite(
      'menu_icon',
      '../dev/assets/images/icons8-circled-menu-90.png',
    );
    ...
    for (var i = 0; i < NUM_HORSES; i++) {
      s_oSpriteLibrary.addSprite(
        'bib_gui_' + i,
        './sprites/bib_gui_' + i + '.png',
      );
      s_oSpriteLibrary.addSprite(
        'horse_' + (i + 1) + '_a',
        './sprites/horse_' + (i + 1) + '_a.png',
      );
      s_oSpriteLibrary.addSprite(
        'horse_' + (i + 1) + '_b',
        './sprites/horse_' + (i + 1) + '_b.png',
      );
      s_oSpriteLibrary.addSprite('cage_' + i, './sprites/cage_' + i + '.png');
      s_oSpriteLibrary.addSprite(
        'gate_' + i,
        './sprites/cage_gates/gate_' + i + '.png',
      );
    }

    s_oSpriteLibrary.addSprite(
      'cage_' + NUM_HORSES,
      './sprites/cage_' + NUM_HORSES + '.png',
    );
    s_oSpriteLibrary.addSprite(
      'gate_' + NUM_HORSES,
      './sprites/cage_gates/gate_' + NUM_HORSES + '.png',
    );

    for (var j = 0; j < NUM_TRACK_BG; j++) {
      s_oSpriteLibrary.addSprite(
        'bg_track_' + j,
        './sprites/bg_track/bg_track_' + j + '.jpg',
      );
    }
