function CGameSettings(oJsonData) {
  ...
  this._initForecastOdd = function () {
    ...
    for (var k = 0; k < aForecast.length; k++) {
      _aForecastOdd[aForecast[k].first - 1][aForecast[k].second - 1] =
        aForecast[k].odd;
    }
  };
  ...
  this._initPaths = function () {
    ...
    var aPlace8 = [
      { x: 190, frame: 30 },
      { x: 200, frame: 270 },
      { x: ARRIVAL_X - HORSE_WIDTH / 2 - 1000, frame: 490 },
    ...
    var aPlace8 = [
      { x: 210, frame: 30 },
      { x: 20, frame: 280 },
      { x: ARRIVAL_X - HORSE_WIDTH / 2 - 1000, frame: 480 },
      { x: CANVAS_WIDTH + HORSE_WIDTH, frame: 65 },
    ];
    _aPathSequence.push({
      place_1: aPlace1,
    ...
    var aPlace8 = [
      { x: 200, frame: 50 },
      { x: 250, frame: 300 },
      { x: ARRIVAL_X - HORSE_WIDTH / 2 - 1000, frame: 440 },
      { x: CANVAS_WIDTH + HORSE_WIDTH, frame: 65 },
    ];
    _aPathSequence.push({
      place_1: aPlace1,
