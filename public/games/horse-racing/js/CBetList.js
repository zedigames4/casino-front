function CBetList() {
  ...
  this.addSimpleBet = function (iHorseIndex, iPlace, iBet) {
    ...
    _aHistory.push({
      type_bet: 'simple',
      horses: [{ index: iHorseIndex, place: iPlace }],
      bet: iBet,
      win: iWin,
    });
  };
  ...
  this.addForecastBet = function (iFirst, iSecond, iBet) {
    ...
    _aHistory.push({
      type_bet: 'forecast',
      horses: [
        { index: iFirst, place: 1 },
        { index: iSecond, place: 2 },
      ],
      bet: iBet,
      win: iBet * s_oGameSettings.getForecastOdd(iFirst, iSecond),
    });
  };
  ...
  this.getTotWinWithCurRank = function (aRank) {
    ...
    if (_aBetPerHorse[aRank[0]]['place_1'] > 0) {
      iWin =
        _aBetPerHorse[aRank[0]]['place_1'] *
        s_oGameSettings.getOddWin(aRank[0]);
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: aRank[0],
        bet: _aBetPerHorse[aRank[0]]['place_1'],
        type: 'win',
      });
    }
    ...
    if (_aBetPerHorse[aRank[0]]['place_2'] > 0) {
      iWin =
        _aBetPerHorse[aRank[0]]['place_2'] *
        s_oGameSettings.getOddPlace(aRank[0]);
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: aRank[0],
        bet: _aBetPerHorse[aRank[0]]['place_2'],
        type: 'place',
      });
    }
    ...
    if (_aBetPerHorse[aRank[1]]['place_2'] > 0) {
      iWin =
        _aBetPerHorse[aRank[1]]['place_2'] *
        s_oGameSettings.getOddPlace(aRank[1]);
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: aRank[1],
        bet: _aBetPerHorse[aRank[1]]['place_2'],
        type: 'place',
      });
    }
    ...
    if (_aBetPerHorse[aRank[0]]['place_3'] > 0) {
      iWin =
        _aBetPerHorse[aRank[0]]['place_3'] *
        parseFloat(s_oGameSettings.getOddShow(aRank[0]));
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: aRank[0],
        bet: _aBetPerHorse[aRank[0]]['place_3'],
        type: 'show',
      });
    }
    ...
    if (_aBetPerHorse[aRank[1]]['place_3'] > 0) {
      iWin =
        _aBetPerHorse[aRank[1]]['place_3'] *
        s_oGameSettings.getOddShow(aRank[1]);
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: aRank[1],
        bet: _aBetPerHorse[aRank[1]]['place_3'],
        type: 'show',
      });
    }
    ...
    if (_aBetPerHorse[aRank[2]]['place_3'] > 0) {
      iWin =
        _aBetPerHorse[aRank[2]]['place_3'] *
        s_oGameSettings.getOddShow(aRank[2]);
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: aRank[2],
        bet: _aBetPerHorse[aRank[2]]['place_3'],
        type: 'show',
      });
    }
    ...
    if (_aForecastBet[aRank[0]][aRank[1]] > 0) {
      iWin =
        _aForecastBet[aRank[0]][aRank[1]] *
        s_oGameSettings.getForecastOdd(aRank[0], aRank[1]);
      iWin = parseFloat(iWin.toFixed(2));
      iTotWin += iWin;
      aWinList.push({
        win: iWin,
        horses: [aRank[0], aRank[1]],
        bet: _aForecastBet[aRank[0]][aRank[1]],
        type: 'forecast',
      });
    }
