function CWinPanel(oParentContainer) {
  ...
  this.show = function (iWin, aWinList, aRank) {
    ...
    var iY = 240;
    for (var j = 0; j < 3; j++) {
      var oSpriteA = s_oSpriteLibrary.getSprite(
        'horse_' + (aRank[j] + 1) + '_a',
      );
      var oSpriteB = s_oSpriteLibrary.getSprite(
        'horse_' + (aRank[j] + 1) + '_b',
      );
      var oData = {
